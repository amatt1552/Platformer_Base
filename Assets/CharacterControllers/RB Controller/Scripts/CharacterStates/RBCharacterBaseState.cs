...
public abstract class RBCharacterBaseState : BaseState
{
    protected RBCharacterStateMachine StateMachine { get; private set; }

    public RBCharacterBaseState() : base() { }
    ...
    public override void Initialization(BaseStateMachine stateMachine, StateFactory characterStateFactory)
    {
        ...
        StateMachine = StateMachine == null ? (RBCharacterStateMachine) stateMachine : StateMachine;
    }
