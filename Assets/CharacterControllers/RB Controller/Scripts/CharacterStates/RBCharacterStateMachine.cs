...
public class RBCharacterStateMachine : BaseStateMachine
{
    [Header("References")]
    public Rigidbody rb;
    ...
    protected override void Awake()
    {
        ...
        currentState = (RBCharacterBaseState)_stateFactory.GetState<SCh_Ground>();
    ...
    protected override void EnterStateListener(BaseState state) 
    {
        ...
        animator.SetFloat("DirZ_OnEnterState", moveInputValue.y);
    }
    #endregion \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    {
        bodyRotation = new(rb.angularVelocity.x, lookValue.x * defaultValues.GetRotationalSpeed(), rb.angularVelocity.z);
